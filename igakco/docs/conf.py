...
latex_documents = [
    (master_doc, 'igakco.tex', u'igakco Documentation',
...
man_pages = [
    (master_doc, 'igakco', u'igakco Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'igakco', u'igakco Documentation',
     author, 'igakco', 'One line description of project.',
     'Miscellaneous'),
]
