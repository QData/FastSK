...
def get_args():
    ...
    parser.add_argument(
        "--datasets", type=str, required=True, help="Where to find the datasets"
    )
    parser.add_argument("--params", type=str, required=True, help="The paramters file")
    parser.add_argument(
        "--dict", type=str, required=True, help="The protein dictionary file"
    ),
    parser.add_argument(
        "--out", type=str, required=True, help="Name of log file to save results"
    )
